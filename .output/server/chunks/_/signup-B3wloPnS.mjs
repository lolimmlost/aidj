...
import { d as Route$4, B as Button, a as authQueryOptions } from './ssr.mjs';
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-xl font-bold", children: "Sign up for Acme Inc." })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "name", children: "Name" }),
          /* @__PURE__ */ jsx(Input, { id: "name", name: "name", type: "text", placeholder: "John Doe", readOnly: isLoading, required: true })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
...
export { SignupForm as component };
//# sourceMappingURL=signup-B3wloPnS.mjs.map
