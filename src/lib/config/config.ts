...
if (typeof window !== 'undefined') {
  ...
  currentConfig = {
    ...
    navidromeUrl: process.env.NAVIDROME_URL || fileConfig.navidromeUrl || defaults.navidromeUrl,
    lidarrUrl: process.env.LIDARR_URL || fileConfig.lidarrUrl || defaults.lidarrUrl,
    lidarrApiKey: process.env.LIDARR_API_KEY || fileConfig.lidarrApiKey || '',
    metubeUrl: process.env.METUBE_URL || fileConfig.metubeUrl || defaults.metubeUrl,
